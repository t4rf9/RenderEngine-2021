...
__device__ Material::Material(const Vector3f &d_color, const Vector3f &s_color, float shininess,
...
__device__ Vector3f Material::Shade(const Ray &ray, const Hit &hit, const Vector3f &dirToLight,

...
__host__ __device__ Vector4f::Vector4f(const Vector2f &xy, float z, float w) {
    m_elements[0] = xy.x();
    m_elements[1] = xy.y();
    m_elements[2] = z;
    m_elements[3] = w;
...
__host__ __device__ Vector4f::Vector4f(float x, const Vector2f &yz, float w) {
    m_elements[0] = x;
    m_elements[1] = yz.x();
    m_elements[2] = yz.y();
    m_elements[3] = w;
...
__host__ __device__ Vector4f::Vector4f(float x, float y, const Vector2f &zw) {
    m_elements[0] = x;
    m_elements[1] = y;
    m_elements[2] = zw.x();
    m_elements[3] = zw.y();
...
__host__ __device__ Vector4f::Vector4f(const Vector2f &xy, const Vector2f &zw) {
    m_elements[0] = xy.x();
    m_elements[1] = xy.y();
    m_elements[2] = zw.x();
    m_elements[3] = zw.y();
...
__host__ __device__ float &Vector4f::x() { return m_elements[0]; }

__host__ __device__ float &Vector4f::y() { return m_elements[1]; }

__host__ __device__ float &Vector4f::z() { return m_elements[2]; }

__host__ __device__ float &Vector4f::w() { return m_elements[3]; }

__host__ __device__ float Vector4f::x() const { return m_elements[0]; }

__host__ __device__ float Vector4f::y() const { return m_elements[1]; }

__host__ __device__ float Vector4f::z() const { return m_elements[2]; }
